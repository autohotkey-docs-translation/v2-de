indexData = [
  ...
  ["Add-Methode (GuiControl)","lib/GuiControl.htm#Add",7],
  ["Add-Methode (ListView)","lib/ListView.htm#Add",7],
  ["Add-Methode (Menu)","lib/Menu.htm#Add",7],
  ["Add-Methode (TreeView)","lib/TreeView.htm#Add",7],
  ...
  ["Choose-Methode (GuiControl)","lib/GuiControl.htm#Choose",7],
  ["Chr","lib/Chr.htm",2],
  ...
  ["ClassNN-Eigenschaft (GuiControl)","lib/GuiControl.htm#ClassNN",7],
  ...
  ["copy folder/directory","lib/DirCopy.htm"],["Kopieren eines Ordners/Verzeichnisses","lib/DirCopy.htm"],
  ...
  ["create folder/directory","lib/DirCreate.htm"],["Erstellen eines Ordners/Verzeichnisses","lib/DirCreate.htm"],
  ...
  ["Delete-Methode (GuiControl)","lib/GuiControl.htm#Delete",7],
  ["Delete-Methode (ListView)","lib/ListView.htm#Delete",7],
  ["Delete-Methode (Map)","lib/Map.htm#Delete",7],
  ["Delete-Methode (Menu)","lib/Menu.htm#Delete",7],
  ["Delete-Methode (TreeView)","lib/TreeView.htm#Delete",7],
  ["DeleteCol-Methode (ListView)","lib/ListView.htm#DeleteCol",7],
  ...
  ["Enabled-Eigenschaft (GuiControl)","lib/GuiControl.htm#Enabled",7],
  ...
  ["floating point (check if it is one)","lib/Is.htm"],["Fließkomma (ob es dies ist)","lib/Is.htm"],
  ["Floating-Point (Format)","lib/Format.htm"],
  ["Floor","lib/Math.htm#Floor",2],
  ["focus","lib/ControlFocus.htm"],["Fokus","lib/ControlFocus.htm"],
  ["Focus-Methode (GuiControl)","lib/GuiControl.htm#Focus",7],
  ["Focused-Eigenschaft (GuiControl)","lib/GuiControl.htm#Focused",7],
  ...
  ["Get-Methode (TreeView)","lib/TreeView.htm#Get",7],
  ["GetChild-Methode (TreeView)","lib/TreeView.htm#GetChild",7],
  ["GetClientPos-Methode (Gui)","lib/Gui.htm#GetClientPos",7],
  ["GetCount-Methode (ListView)","lib/ListView.htm#GetCount",7],
  ["GetCount-Methode (TreeView)","lib/TreeView.htm#GetCount",7],
  ...
  ["GetNext-Methode (ListView)","lib/ListView.htm#GetNext",7],
  ["GetNext-Methode (TreeView)","lib/TreeView.htm#GetNext",7],
  ["GetOwnPropDesc-Methode (Object)","lib/Object.htm#GetOwnPropDesc",7],
  ["GetParent-Methode (TreeView)","lib/TreeView.htm#GetParent",7],
  ["GetPos-Methode (Gui)","lib/Gui.htm#GetPos",7],
  ["GetPos-Methode (GuiControl)","lib/GuiControl.htm#GetPos",7],
  ["GetPrev-Methode (TreeView)","lib/TreeView.htm#GetPrev",7],
  ["GetSelection-Methode (TreeView)","lib/TreeView.htm#GetSelection",7],
  ["GetText-Methode (ListView)","lib/ListView.htm#GetText",7],
  ["GetText-Methode (TreeView)","lib/TreeView.htm#GetText",7],
  ...
  ["Gui","lib/Gui.htm",6],
  ["Gui (eine GUI erstellen)","lib/Gui.htm#Call"],
  ["Gui-Steuerelemente","lib/GuiControls.htm"],
  ["Gui-Ereignisse","lib/GuiOnEvent.htm"],
  ["Gui-Eigenschaft (GuiControl)","lib/GuiControl.htm#Gui",7],
  ...
  ["Hwnd-Eigenschaft (GuiControl)","lib/GuiControl.htm#Hwnd",7],
  ...
  ["Insert-Methode (ListView)","lib/ListView.htm#Insert",7],
  ["Insert-Methode (Menu)","lib/Menu.htm#Insert",7],
  ["InsertAt-Methode (Array)","lib/Array.htm#InsertAt",7],
  ["InsertCol-Methode (ListView)","lib/ListView.htm#InsertCol",7],
  ...
  ["Integer (ob es dies ist)","lib/Is.htm"],
  ...
  ["Modify-Methode (ListView)","lib/ListView.htm#Modify",7],
  ["Modify-Methode (TreeView)","lib/TreeView.htm#Modify",7],
  ["ModifyCol-Methode (ListView)","lib/ListView.htm#ModifyCol",7],
  ...
  ["move folder/directory","lib/DirMove.htm"],["Verschieben eines Ordners/Verzeichnisses","lib/DirMove.htm"],
  ["Move-Methode (Gui)","lib/Gui.htm#Move",7],
  ["Move-Methode (GuiControl)","lib/GuiControl.htm#Move",7],
  ...
  ["Name-Eigenschaft (GuiControl)","lib/GuiControl.htm#Name",7],
  ...
  ["number (check if it is one)","lib/Is.htm"],["Nummer (ob es eine ist)","lib/Is.htm"],
  ...
  ["OnCommand-Methode (GuiControl)","lib/GuiControl.htm#OnCommand",7],
  ...
  ["OnEvent-Methode (GuiControl)","lib/GuiControl.htm#OnEvent",7],
  ...
  ["OnNotify-Methode (GuiControl)","lib/GuiControl.htm#OnNotify",7],
  ...
  ["Opt-Methode (GuiControl)","lib/GuiControl.htm#Opt",7],
  ...
  ["Redraw-Methode (GuiControl)","lib/GuiControl.htm#Redraw",7],
  ...
  ["SetFont-Methode (GuiControl)","lib/GuiControl.htm#SetFont",7],
  ["SetFormat-Methode (GuiControl)","lib/GuiControl.htm#SetFormat",7],
  ["SetIcon-Methode (Menu)","lib/Menu.htm#SetIcon",7],
  ["SetImageList-Methode (ListView)","lib/ListView.htm#SetImageList",7],
  ["SetImageList-Methode (TreeView)","lib/TreeView.htm#SetImageList",7],
  ...
  ["Text-Eigenschaft (GuiControl)","lib/GuiControl.htm#Text",7],
  ...
  ["Type","lib/Type.htm",2],
  ["Type-Eigenschaft (GuiControl)","lib/GuiControl.htm#Type",7],
  ...
  ["UseTab-Methode (GuiControl)","lib/GuiControl.htm#UseTab",7],
  ["Value-Eigenschaft (GuiControl)","lib/GuiControl.htm#Value",7],
  ...
  ["Visible-Eigenschaft (GuiControl)","lib/GuiControl.htm#Visible",7],
